...
export function Quiz({ question, options, answer, explanation }: QuizProps) {
  ...
  return (
    <div className="my-8 rounded-2xl border border-extralightblue bg-extralightblue/20 p-5">
      ...
      <div className="space-y-2 ml-8">
        {options.map((option, i) => (
          <button
            ...
            disabled={answered}
            className={cn(
              "w-full text-left rounded-xl px-4 py-2.5 text-sm font-googletexte transition-all border",
      ...
      {answered && explanation && (
        <div className={cn(
          "mt-4 ml-8 rounded-xl px-4 py-3 text-sm font-googletexte",
