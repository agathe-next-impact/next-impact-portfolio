...
export function ContactDirectInfo() {
  ...
  return (
    <div className="h-full bg-jet px-6 py-8 lg:px-8 lg:py-10">
      <p className="mb-6 font-mono text-2xs uppercase tracking-[0.14em] text-mid-gray">
      ...
      <div className="mt-5 flex flex-col gap-3">
        <a
          ...
          className="group inline-flex items-center gap-2 font-inter-tight text-base text-mid-gray transition-colors hover:text-foreground"
        >
        ...
        <span className="inline-flex items-center gap-2 font-inter-tight text-base text-mid-gray">
