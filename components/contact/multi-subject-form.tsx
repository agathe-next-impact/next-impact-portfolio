...
const LEGACY_SUBJECTS: Record<string, SubjectKey> = {
  "pack-ia": "autre",
  // L'offre récurrente est de retour sous le nom « Expert technique externalisé » : les
