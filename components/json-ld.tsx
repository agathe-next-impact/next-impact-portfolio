        ...
        itemListElement: [
          {
            ...
            description: "Site vitrine WordPress avec thème custom moderne, build optimisé et sécurité durcie. Conservation de l'admin, modernisation du front.",
            price: "2250",
            priceCurrency: "EUR",
          ...
          },
          {
            ...
            description: "WordPress headless en backend, Astro en frontend (SSG, hydratation partielle). Performance front et SEO de niveau industriel.",
            price: "4000",
            priceCurrency: "EUR",
            url: `${siteConfig.url}/services`,
          },
          {
            ...
            description: "Architecture WordPress headless + Next.js App Router (SSG/ISR/SSR), TypeScript, multisites et CI/CD complet.",
            price: "5000",
            priceCurrency: "EUR",
            url: `${siteConfig.url}/services`,
          },
