...
import { CASE_STUDY_PROFILE_OVERRIDES } from "@/lib/case-studies-profiles";
...
export default function CaseStudyProfileContent({
  ...
  const override =
    profileId && CASE_STUDY_PROFILE_OVERRIDES[slug]
      ? CASE_STUDY_PROFILE_OVERRIDES[slug][profileId]
      : null;
