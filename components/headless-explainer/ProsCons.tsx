  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="border-b border-dark-gray p-6 md:border-b-0 md:border-r">
        <h4 className="mb-5 font-mono text-2xs uppercase tracking-[0.12em] text-accent-secondary">
      ...
      <div className="bg-jet p-6">
        <h4 className="mb-5 font-mono text-2xs uppercase tracking-[0.12em] text-mid-gray">
          {isEn ? "Limits" : "Limites"}
        </h4>
        <div className="space-y-3">
          {cons.map((con) => (
            <div key={con.label} className="border-l border-dark-gray py-1 pl-4">
              ...
              <p className="mt-1 font-inter-tight text-base leading-relaxed text-mid-gray">{con.description}</p>
            </div>
          ))}
        </div>
      </div>
