...
export const BENTO_CONFIGS: Record<ProfileId, BentoCardConfig[]> = {
  decideur: [
    ...
    },
    {
      ...
      description: "Cadrer, piloter et livrer votre projet.",
      icon: FileText,
    ...
    },
    {
      id: "dec-migration",
      title: "Migrer vers le headless",
      description: "Transition sans interruption.",
      icon: ArrowRightLeft,
  ...
  utilisateur: [
    ...
    },
    {
      ...
      description: "Administrer un headless simplement.",
      icon: PenTool,
      href: "/documentation/headless-cms/gerer-le-contenu",
      colSpan: "md:col-span-1",
      rowSpan: "",
      gradient: "bg-darkblue/90",
      textColor: "text-white",
    ...
    },
    {
      id: "util-medias",
      title: "Médias & Images",
      description: "Optimiser vos visuels en headless.",
      icon: Image,
      href: "/documentation/headless-cms/gestion-des-medias-headless",
      colSpan: "md:col-span-1",
      rowSpan: "",
      gradient: "bg-gradient-to-br from-lightblue/30 to-mediumblue/80 backdrop-blur-sm",
      textColor: "text-white",
  ...
  developpeur: [
    ...
    },
    {
      ...
      description: "SSG, SSR, ISR et composants React.",
      icon: Monitor,
    ...
    },
    {
      id: "dev-seo",
      title: "SEO technique",
      description: "Performance, indexation et outils.",
      icon: Search,
      href: "/documentation/seo",
      colSpan: "md:col-span-1",
      rowSpan: "",
