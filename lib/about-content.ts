...
const FR: AboutContent = {
  tldr: {
    ...
    lines: [
      ...
      "25 ans de pratique — du PHP/MySQL de 2000 aux stacks Next.js, PostgreSQL et headless — dont 15 ans à piloter des projets côté édition.",
    ...
    items: [
      {
        ...
        answer:
          "Développeuse et fondatrice de Next Impact, elle conseille et construit des projets web à l'heure de l'IA. Son parcours réunit quatre compétences — technique, business, marketing et design — après 25 ans de pratique du web, dont 15 ans côté édition.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "En tenant la maîtrise d'ouvrage — cadrage, architecture, contrôle qualité — pendant que l'IA, guidée par 25 ans d'expérience, tient le chantier. Ce duo rend accessibles des projets d'une complexité auparavant réservée aux grandes structures. Le conseil oriente, la construction suit.",
      },
      {
...
const EN: AboutContent = {
  tldr: {
    ...
    lines: [
      ...
      "25 years of practice — from PHP/MySQL in 2000 to Next.js, PostgreSQL and headless stacks — including 15 years steering projects on the editorial side.",
    ...
    items: [
      {
        ...
        answer:
          "A developer and the founder of Next Impact, she advises on and builds web projects in the age of AI. Her background brings together four skills — technical, business, marketing and design — after 25 years of web practice, including 15 years on the editorial side.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "By holding the project ownership — scoping, architecture, quality control — while AI, guided by 25 years of experience, runs the build. This pairing makes projects of a complexity once reserved for large firms accessible. Advice guides, implementation follows.",
      },
      {
