...
export const PACKS: PriceItem[] = [
  ...
  },
  {
    ...
    price: "520 €",
    value: 520,
    fr: { name: "Pack 5h", desc: "Intervention plus large sur site existant." },
    en: { name: "5h pack", desc: "Broader intervention on an existing site." },
  },
  {
    id: "maintenance-ponctuelle",
    price: "Sur devis",
    value: 0,
    featured: true,
    fr: { name: "Maintenance ponctuelle", tag: "Stabilisation", desc: "Nettoyage, reprise technique ou stabilisation d'un WordPress fragile." },
    en: { name: "One-off maintenance", tag: "Stabilization", desc: "Cleanup, technical recovery or stabilization of a fragile WordPress." },
  },
];
