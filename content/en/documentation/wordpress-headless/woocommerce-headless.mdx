...
<TldrCallout label="TL;DR">
  Running WooCommerce in headless mode means keeping WordPress + WooCommerce as the backend (catalog, orders, customers, payments) and rebuilding the buying experience on the Next.js side. Communication happens through the WooCommerce REST API or through WPGraphQL with the WooGraphQL extension. This setup frees the store's design and noticeably improves product page LCP.
</TldrCallout>
