...
Indicative ranges for an SMB site (30 to 100 pages), broken down line by line in [how much a headless WordPress costs in 2026](/blog/combien-coute-wordpress-headless-2026-chiffre):

<StatGrid>
  <StatCard value="€2,250" label="Essential" description="Tight scope: a Next.js front on an existing, healthy WordPress" accent="blue" />
  <StatCard value="€4,000" label="Standard" description="The typical project: front rebuild, content migration, optimization" accent="orange" />
  <StatCard value="€6,500+" label="Complete" description="Extended scope: specific features, integrations, multilingual" accent="coral" />
</StatGrid>

Beyond these scopes (large-catalog e-commerce, business platforms), you enter [custom web app](/documentation/applications-web-mobile/combien-coute-une-web-app-sur-mesure) territory — then budget yearly running costs on top (€510 to €1,355 for a standard headless setup).
