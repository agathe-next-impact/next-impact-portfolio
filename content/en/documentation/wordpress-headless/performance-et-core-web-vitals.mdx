...
<TldrCallout label="TL;DR">
  A headless WordPress generally makes Core Web Vitals easier to hit in the green: LCP &lt; 2.5 s, INP &lt; 200 ms, CLS &lt; 0.1. The gain comes from removing live PHP rendering, serving pre-generated HTML from a CDN, native image optimization in Next.js, and deferred loading of non-critical JavaScript. These are official Google metrics used as ranking signals.
</TldrCallout>
