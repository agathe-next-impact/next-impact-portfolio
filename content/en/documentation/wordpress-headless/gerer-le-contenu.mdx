...
<TldrCallout label="TL;DR">
  In headless WordPress, the admin stays exactly the same as in a classic WordPress: Gutenberg editor, media library, user roles, editing plugins (ACF, Yoast). Only the public rendering layer changes. Editors keep their habits; the only new workflow step is preview, which now goes through Next.js Draft Mode.
</TldrCallout>
