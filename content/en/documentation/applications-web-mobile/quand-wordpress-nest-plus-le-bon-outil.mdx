...
- [Member area, client portal, extranet](/documentation/applications-web-mobile/espace-membre-portail-client-extranet): the typical case where WordPress hits its limit
