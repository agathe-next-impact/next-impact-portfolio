...
description: "Cost breakdown (scoping, design, dev, infrastructure, maintenance), ranges by typology, levers for reduction (TIH/OETH), traps to avoid."
...
Conditions: your vendor must be a TIH (French independent worker with disability) — that's my status. [Learn more about the OETH benefit](/avantage-oeth).
...
- [The OETH benefit: 30% AGEFIPH deduction](/avantage-oeth)
