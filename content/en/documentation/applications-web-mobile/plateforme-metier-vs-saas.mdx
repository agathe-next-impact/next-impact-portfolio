...
- [Integrating your platform: CRM, ERP, payment](/documentation/applications-web-mobile/interconnecter-sa-plateforme-crm-erp-paiement): how SaaS and custom communicate
- [From spreadsheet to web platform](/documentation/applications-web-mobile/du-tableur-a-la-plateforme-web): when to automate a business process
