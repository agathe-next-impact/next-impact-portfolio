...
faq:
  ...
  - question: "Combien coûte une démarche GEO pour une PME ?"
    answer: "Pour une PME vitrine, comptez 3 à 7 jours de travail (réécriture des pages clés en réponses, FAQ, balisage) — en interne ou entre 2 000 et 6 000 € en prestation, selon le volume de pages. Ce n'est pas un abonnement : c'est surtout un investissement initial sur le contenu, puis un entretien léger."
...
En prestation complète, une démarche GEO initiale pour une PME se situe généralement **entre 2 000 et 6 000 €** selon le volume de pages — un ordre de grandeur, pas un devis : le vrai chiffrage dépend de l'état de votre socle SEO et de votre site.
...
Pour une PME vitrine, comptez 3 à 7 jours de travail (réécriture des pages clés en réponses, FAQ, balisage) — en interne, ou entre 2 000 et 6 000 € en prestation selon le volume de pages. Ce n'est pas un abonnement : c'est surtout un investissement initial sur le contenu, puis un entretien léger au fil des évolutions des moteurs.
