...
<TldrCallout>
  En pratique, utiliser WordPress en headless ne demande pas de changer d'installation : toute version 4.7 ou supérieure expose nativement une API REST sur `/wp-json/`. Il suffit de désactiver le rendu public du thème, de déployer un front-end Next.js qui consomme cette API, et d'orienter le domaine principal vers le front. Les éditeurs continuent de travailler dans le back-office habituel.
</TldrCallout>
