...
<TldrCallout>
  Un WordPress headless fonctionne en trois couches découplées : WordPress stocke et structure le contenu en base, une API (REST native ou WPGraphQL) l'expose au format JSON, et un frontend indépendant (le plus souvent Next.js) consomme cette API pour générer les pages. Les éditeurs continuent d'utiliser le back-office WordPress sans changement.
</TldrCallout>
...
- Le choix du framework front-end (Next.js, Nuxt, Gatsby, etc.) est libre
