...
<ComparisonTable
  ...
  rows={[
    { label: "Coût mensuel (tarifs publics 2026)", left: "≈ 5-15 € HT", right: "≈ 25-60 € HT" },
    { label: "Performance", left: "Variable, ressources partagées", right: "Élevée, ressources dédiées ou optimisées" },
    { label: "Administration", left: "Minimale", right: "Complète (VPS) ou déléguée (managé)" },
    { label: "Exemples", left: "o2switch, OVH", right: "Kinsta, WP Engine, DigitalOcean" },
    { label: "Adapté pour", left: "Sites éditoriaux, back-office peu sollicité", right: "Back-office intensif, exigences de SLA, staging intégré" },
  ]}
/>
