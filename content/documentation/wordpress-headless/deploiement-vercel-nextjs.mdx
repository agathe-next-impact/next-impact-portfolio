...
<TldrCallout>
  Pour mettre en ligne un site WordPress headless, on déploie le frontend Next.js sur Vercel (ou Netlify, Cloudflare Pages) tandis que WordPress reste sur un hébergement PHP classique ou managé. Vercel se connecte au dépôt Git, build à chaque push et sert le site depuis un CDN mondial. La connexion au back-end passe par les variables d'environnement contenant l'URL de l'API WordPress.
</TldrCallout>
