...
<TldrCallout>
  Le frontend désigne la couche logicielle qui s'exécute dans le navigateur et qui produit ce que voit le visiteur. Dans un WordPress headless, le rôle de frontend, traditionnellement assuré par le thème PHP, est confié à un framework JavaScript autonome — le plus souvent Next.js (React), parfois Nuxt (Vue) ou Astro — qui consomme l'API WordPress pour générer chaque page.
</TldrCallout>
