...
<TldrCallout>
  Next.js est le framework front-end de référence pour WordPress headless parce qu'il combine rendu statique, rendu serveur et régénération incrémentale (ISR) dans un même projet, ce qui permet de servir un site rapide même quand le contenu WordPress change souvent. Son optimisation native des images, des polices et du JavaScript se traduit par des Core Web Vitals au vert sans configuration spécifique.
</TldrCallout>
