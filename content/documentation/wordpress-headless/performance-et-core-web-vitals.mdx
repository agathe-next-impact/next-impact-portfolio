...
<TldrCallout>
  Un WordPress headless rend généralement les Core Web Vitals plus faciles à passer au vert : LCP &lt; 2,5 s, INP &lt; 200 ms, CLS &lt; 0,1. Le gain vient de la suppression du rendu PHP en temps réel, du HTML pré-généré servi depuis un CDN, de l'optimisation native des images par Next.js et du chargement différé du JavaScript non critique. Ce sont des métriques officielles de Google retenues comme facteurs de classement.
</TldrCallout>
