...
<TldrCallout>
  WordPress headless est pertinent pour les sites d'entreprise multi-canaux (web + app mobile + bornes), les sites à fort trafic où la performance conditionne le SEO, les sites éditoriaux à publication fréquente, et les boutiques WooCommerce cherchant un parcours d'achat sur-mesure. Pour un site vitrine de moins de 20 pages sans contrainte de performance, un WordPress classique bien optimisé suffit généralement.
</TldrCallout>
