...
<TldrCallout>
  Une architecture headless sépare la gestion du contenu (back-end) de son affichage (front-end). En WordPress headless, WordPress conserve son rôle de CMS et expose les contenus via une API (REST ou GraphQL), tandis qu'un front-end distinct — par exemple Next.js — produit les pages publiques. Cette séparation autorise des performances et une liberté de design impossibles avec un thème PHP.
</TldrCallout>
