...
faq:
  ...
  - question: "Les plugins WordPress fonctionnent-ils encore en mode headless ?"
    answer: "Ceux qui agissent côté back-office continuent de fonctionner : champs personnalisés (ACF), SEO (les métadonnées sont exposées via l'API), formulaires côté gestion, sauvegarde, sécurité. En revanche, les plugins qui injectent de l'affichage dans les pages publiques (sliders, popups, page builders) sont remplacés par des composants du front-end."
---
