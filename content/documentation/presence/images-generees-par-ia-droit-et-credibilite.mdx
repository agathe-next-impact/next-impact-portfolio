...
- **La réglementation générale — RGPD sur les données confiées à un outil tiers, obligations d'étiquetage de l'AI Act européen pour certains contenus synthétiques — n'est pas traitée ici** ; elle fait l'objet d'un article dédié : [RGPD et AI Act : quelles obligations pour votre site ?](/documentation/presence/rgpd-et-ai-act-obligations-legales).

{/*
  TODO éditorial (Agathe) : cet encadré « Ce que je constate en clientèle »
  (format Callout variant="decideur") attend un cas réel — par exemple une
  hésitation client entre un shooting photo et des visuels IA pour une page
  « qui sommes-nous », un visuel généré retiré après un commentaire de
  visiteur, ou à l'inverse un usage décoratif d'image IA qui n'a jamais posé
  de problème. Ne pas publier tel quel — remplacer par une anecdote
  vérifiable avant mise en ligne. Voir consigne anti-invention du chantier.
*/}
...
- Parlement européen et Conseil de l'UE, [Règlement (UE) 2024/1689 (AI Act), article 50](https://eur-lex.europa.eu/eli/reg/2024/1689/oj/eng) : obligations de transparence sur les contenus synthétiques, mentionné pour mémoire — traité en détail dans [RGPD et AI Act : quelles obligations pour votre site ?](/documentation/presence/rgpd-et-ai-act-obligations-legales).
