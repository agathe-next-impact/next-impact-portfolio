...
faq:
  ...
  - question: "Mon chatbot doit-il dire qu'il est une intelligence artificielle ?"
    answer: "Oui, depuis le 2 août 2026 : l'article 50 du règlement européen sur l'IA impose d'informer clairement un visiteur qu'il échange avec un système d'IA, sauf si c'est déjà évident du contexte. Le détail des usages et limites d'un chatbot sur un site est traité dans l'article dédié de la rubrique Outils métier."
...
Oui, depuis le 2 août 2026 : l'article 50 du règlement européen sur l'IA impose d'informer clairement un visiteur qu'il échange avec un système d'IA, sauf si c'est déjà évident du contexte. Le détail des usages et limites d'un chatbot sur un site est traité dans l'article dédié de la rubrique Outils métier.
