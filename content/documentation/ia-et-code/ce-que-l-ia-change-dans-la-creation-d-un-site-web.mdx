...
faq:
  ...
  - question: "Les agences web utilisent-elles l'IA ? Est-ce un problème ?"
    answer: "La quasi-totalité des professionnels du développement utilisent aujourd'hui l'IA — environ 90 % selon l'étude DORA 2025 de Google. Ce n'est pas un problème en soi : c'est devenu la manière normale de produire. Ce qui compte, c'est ce que le prestataire fait autour — relecture, tests, architecture — et sa transparence quand vous lui posez la question."
...
### Les agences web utilisent-elles l'IA ? Est-ce un problème ?

La quasi-totalité des professionnels du développement utilisent aujourd'hui l'IA — environ 90 % selon [l'étude DORA 2025](https://dora.dev/dora-report-2025/). Ce n'est pas un problème : c'est devenu la manière normale de produire, comme personne ne code plus sans éditeur moderne. Ce qui compte, c'est ce que le prestataire fait autour — relecture, tests, architecture — et sa transparence quand vous lui posez la question.
