...
> Page pilière — hub « Quelle techno web ? ». Rédigée le 12 juillet 2026.
> Cible : décideurs PME / ESS / B2B, prospects froids. Voix : « je » (Agathe),
> claire, nuancée, sans jargon. Corps d'article ≈ 1 900 mots.
> Contraintes GEO : phrase-réponse en tête de section, blocs courts extractibles,
> stats sourcées et datées, FAQ balisable FAQPage, auteur nommé + bio, JSON-LD.
...
*Par Agathe Karinthi-Martin — publié le 12 juillet 2026.*
...
## 2. Les trois voies : construire, générer, acheter
...
C'est le bon choix quand vos besoins entrent dans les cas prévus par la plateforme : site vitrine, blog, petit catalogue. Vous bénéficiez de dix ans de problèmes déjà résolus, pour un budget maîtrisé et un délai de quelques semaines.

Le piège a deux visages. Côté WordPress : le parc vieillissant. Un site de 2018, trente plugins empilés, plus personne pour maintenir — lent, vulnérable, et pénalisé par les moteurs comme par les IA. Côté no-code fermé : le lock-in. Le jour où vous voulez partir, vous découvrez que vos pages, vos gabarits et parfois vos contenus ne s'exportent pas. Vous ne possédez pas votre site ; vous le louez.

## 3. Les cinq critères qui tranchent
...
## 4. Le méta-principe : choisir durable quand tout change
...
**Vous hésitez encore entre deux voies ?** C'est précisément l'objet du [choix de techno web avec l'IA](/conseil) : 30 minutes pour trancher votre cas précis, avec une recommandation claire et argumentée — 150 € HT, intégralement crédités si un projet démarre avec moi sous 30 jours. Pour dégrossir seul avant, la [Boussole techno](/outils/boussole) vous oriente en cinq minutes.
...
## Sources citées (à vérifier au moment de la mise en ligne)

- McKinsey, *The State of AI* (mars 2025) : 71 % des organisations utilisent
  régulièrement l'IA générative dans au moins une fonction.
- Gartner (communiqué, février 2024) : prévision de −25 % de volume sur les
  moteurs de recherche classiques d'ici 2026, au profit des assistants IA.
- W3Techs, *Usage statistics of content management systems* (relevé 2025) :
  WordPress ≈ 43 % de l'ensemble des sites, > 60 % du marché des CMS.

## Suggestions JSON-LD

À intégrer dans le `@graph` existant de `components/json-ld.tsx` (réutiliser les
entités `Person` / `Organization` déjà déclarées via `@id` plutôt que de les
dupliquer — les `sameAs` registres/SIREN y sont déjà).
...
```json
{
  ...
  "@graph": [
    {
      "@type": "Article",
      "@id": "https://next-impact.digital/documentation/choisir/quelle-techno-ia#article",
      "headline": "Quelle techno pour votre site à l'heure de l'IA ?",
      "description": "Sur-mesure, builders IA ou WordPress/no-code : les trois voies pour créer un site en 2026, cinq critères d'arbitrage et un principe de durabilité.",
      "inLanguage": "fr",
      "datePublished": "2026-07-12",
      "dateModified": "2026-07-12",
      "author": { "@id": "https://next-impact.digital/#agathe" },
      "publisher": { "@id": "https://next-impact.digital/#organization" },
      "isPartOf": { "@id": "https://next-impact.digital/documentation#hub" }
    },
    {
      "@type": "FAQPage",
      "@id": "https://next-impact.digital/documentation/choisir/quelle-techno-ia#faq",
      "mainEntity": [
        { "@type": "Question", "name": "Une IA peut-elle vraiment créer mon site pour 20 € par mois ?", "acceptedAnswer": { "@type": "Answer", "text": "Oui pour un prototype ou un test d'idée ; non pour un site de production qui doit convertir, être maintenu et rester visible dans Google et les assistants IA." } },
        { "@type": "Question", "name": "WordPress est-il dépassé en 2026 ?", "acceptedAnswer": { "@type": "Answer", "text": "Non : WordPress propulse environ 43 % des sites web (W3Techs, 2025). Ce qui est dépassé, c'est le WordPress non maintenu." } },
        { "@type": "Question", "name": "Qu'est-ce que le GEO et pourquoi change-t-il le choix de techno ?", "acceptedAnswer": { "@type": "Answer", "text": "Le GEO (Generative Engine Optimization) rend un site lisible et citable par les assistants IA. Il exige un contenu structuré, des données balisées et un site rapide." } },
        { "@type": "Question", "name": "Quel budget prévoir pour un site professionnel en 2026 ?", "acceptedAnswer": { "@type": "Answer", "text": "En coût total sur trois ans : quelques centaines à 2 000 € par an en no-code, 3 000 à 10 000 € pour un WordPress professionnel, 8 000 à 25 000 € et plus en sur-mesure." } },
        { "@type": "Question", "name": "Comment éviter de me tromper de voie ?", "acceptedAnswer": { "@type": "Answer", "text": "Vérifier la réversibilité (contenus exportables, domaine et code récupérables), puis arbitrer sur cinq critères : budget sur trois ans, évolutivité, propriété, SEO + GEO, délai." } }
      ]
    },
    {
      "@type": "Person",
      "@id": "https://next-impact.digital/#agathe",
      "name": "Agathe Karinthi-Martin",
      "jobTitle": "Développeuse web, fondatrice de Next Impact Digital",
      "worksFor": { "@id": "https://next-impact.digital/#organization" }
    },
    {
      "@type": "Service",
      "@id": "https://next-impact.digital/conseil#visio-decision",
      "name": "Visio décision techno",
      "serviceType": "Conseil en choix de technologie web",
      "provider": { "@id": "https://next-impact.digital/#organization" },
      "offers": { "@type": "Offer", "price": "240", "priceCurrency": "EUR" }
    },
    {
      "@type": "BreadcrumbList",
      "itemListElement": [
        { "@type": "ListItem", "position": 1, "name": "Accueil", "item": "https://next-impact.digital/" },
        { "@type": "ListItem", "position": 2, "name": "Documentation", "item": "https://next-impact.digital/documentation" },
        { "@type": "ListItem", "position": 3, "name": "Choisir sa techno", "item": "https://next-impact.digital/documentation/choisir" },
        { "@type": "ListItem", "position": 4, "name": "Quelle techno pour votre site à l'heure de l'IA ?" }
      ]
    }
  ]
}
...
- `Person` et `Service` existent probablement déjà dans `components/json-ld.tsx`
  (le Service « Visio décision techno » y est déclaré) — référencer par `@id`,
  ne pas dupliquer.
- Pas d'`AggregateRating` (règle projet : pas de notation self-serving).
- Maillage interne présent dans le corps : `/conseil`, `/outils/boussole` ;
  candidats supplémentaires selon la section d'intégration :
  `/outils/nocode-saas-surmesure`, `/outils/reparer-ou-refaire`,
  `/outils/decrypteur-devis`, `/outils/prototype-ia`.
