// Page thématique du hub — « Outils métier ». Segment statique (prend le pas sur
// la route dynamique [category]). Tout le contenu vient de lib/hub-themes.ts.

import type { Metadata } from "next";
import { themeMetadata, ThemeRoute } from "@/components/hub/theme-route";
import type { Locale } from "@/i18n/routing";

const SLUG = "outils-metier";
