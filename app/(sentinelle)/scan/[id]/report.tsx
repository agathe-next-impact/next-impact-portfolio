 ...
 */
function ApercuVeille({ scanId, apercu }: { scanId: string; apercu?: ScanApercu }) {
  ...
  if (apercu.status === "pending") {
    return (
      <div className="mt-12" aria-live="polite">
        ...
        <p className="mt-3 font-inter-tight text-base text-mid-gray">
          La lettre croise votre stack avec l'actualité de la semaine écoulée —
          recherche comprise, comme pour un numéro d'abonné. Comptez quelques
          minutes. Laissez votre adresse ci-dessous : elle vous sera envoyée
          dès qu'elle est prête, sans garder cette page ouverte.
        </p>
      </div>
    );
  }
  ...
  return (
    <section className="mt-12">
      ...
      <p className="mt-3 font-inter-tight text-base leading-relaxed text-mid-gray">
        Un numéro rédigé comme pour un abonné — votre stack détectée, croisée
        avec l'actualité de la semaine écoulée — présenté tel que vous le
        recevriez par e-mail.
      </p>
      ...
      <p className="mt-6 font-inter-tight text-sm leading-relaxed text-mid-gray">
        ...
        des faits déjà collectés — <strong className="font-medium text-foreground">non relu</strong>.
      ...
      {envoye ? (
        <>
          <p className="font-inter-tight text-base text-foreground">
            C'est noté : votre lettre de veille part à cette adresse dès
            qu'elle est prête — pensez à vérifier vos courriers indésirables la
            première fois. Ce que ce scan ne peut pas voir — les extensions
        ...
        <form onSubmit={onSubmit}>
          <label htmlFor="email" className="font-mono text-[11px] uppercase tracking-[0.14em] text-mid-gray">
            Recevoir cette lettre de veille par e-mail
          </label>
          ...
          <p className="mt-4 font-inter-tight text-sm leading-relaxed text-mid-gray">
            Votre adresse sert à vous envoyer cette lettre et à vous recontacter.
